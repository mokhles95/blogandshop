...
$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\jms\\payment-core-bundle\\JMS\\Payment\\CoreBundle\\Resources\\config\\doctrine') => 'JMS\\Payment\\CoreBundle\\Entity'));
$b->setGlobalBasename('mapping');

$a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\EntityBundle\\Entity'))), 'EntityBundle\\Entity');
$a->addDriver($b, 'JMS\\Payment\\CoreBundle\\Entity');
...
$instance->setEntityNamespaces(array('EntityBundle' => 'EntityBundle\\Entity', 'JMSPaymentCoreBundle' => 'JMS\\Payment\\CoreBundle\\Entity'));
