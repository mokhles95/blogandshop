 ...
 */
class ProduitIt extends \EntityBundle\Entity\ProduitIt implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\ProduitIt' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\ProduitIt' . "\0" . 'produit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProduitIt $proxy) {
