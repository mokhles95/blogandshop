 ...
 */
class DetailCommande extends \EntityBundle\Entity\DetailCommande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\DetailCommande' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\DetailCommande' . "\0" . 'qte', '' . "\0" . 'EntityBundle\\Entity\\DetailCommande' . "\0" . 'commande'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DetailCommande $proxy) {
