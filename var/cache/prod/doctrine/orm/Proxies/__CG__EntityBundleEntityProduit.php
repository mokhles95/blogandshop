 ...
 */
class Produit extends \EntityBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Produit' . "\0" . 'libelle', '' . "\0" . 'EntityBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'EntityBundle\\Entity\\Produit' . "\0" . 'user', '' . "\0" . 'EntityBundle\\Entity\\Produit' . "\0" . 'wishList'];
        }
