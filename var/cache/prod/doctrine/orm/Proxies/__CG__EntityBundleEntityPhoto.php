 ...
 */
class Photo extends \EntityBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Photo' . "\0" . 'desc', '' . "\0" . 'EntityBundle\\Entity\\Photo' . "\0" . 'article'];
        }
