 ...
 */
class Jaime extends \EntityBundle\Entity\Jaime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Jaime' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Jaime' . "\0" . 'user', '' . "\0" . 'EntityBundle\\Entity\\Jaime' . "\0" . 'article'];
        }
