 ...
 */
class PhotoProduit extends \EntityBundle\Entity\PhotoProduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'imageFile', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'imageName', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'updateAt', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'nom', '' . "\0" . 'EntityBundle\\Entity\\PhotoProduit' . "\0" . 'produit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhotoProduit $proxy) {
