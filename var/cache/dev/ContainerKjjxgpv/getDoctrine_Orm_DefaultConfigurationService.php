...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\EntityBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\YosrBundle\\Entity')));
...
$a->addDriver($b, 'EntityBundle\\Entity');
$a->addDriver($b, 'YosrBundle\\Entity');
$a->addDriver($c, 'JMS\\Payment\\CoreBundle\\Entity');
...
$instance->setEntityNamespaces(array('EntityBundle' => 'EntityBundle\\Entity', 'YosrBundle' => 'YosrBundle\\Entity', 'JMSPaymentCoreBundle' => 'JMS\\Payment\\CoreBundle\\Entity'));
