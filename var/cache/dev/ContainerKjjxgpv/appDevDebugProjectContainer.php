...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'jms\\payment\\corebundle\\command\\generatekeycommand' => 'JMS\\Payment\\CoreBundle\\Command\\GenerateKeyCommand',
            'jms\\payment\\corebundle\\cryptography\\defusephpencryptionservice' => 'JMS\\Payment\\CoreBundle\\Cryptography\\DefusePhpEncryptionService',
            'jms\\payment\\corebundle\\plugincontroller\\entityplugincontroller' => 'JMS\\Payment\\CoreBundle\\PluginController\\EntityPluginController',
            'jms\\payment\\corebundle\\plugincontroller\\plugincontroller' => 'JMS\\Payment\\CoreBundle\\PluginController\\PluginController',
        ...
        $this->fileMap = array(
            ...
            'JMS\\Payment\\CoreBundle\\Command\\GenerateKeyCommand' => 'getGenerateKeyCommandService.php',
            'JMS\\Payment\\CoreBundle\\Cryptography\\DefusePhpEncryptionService' => 'getDefusePhpEncryptionServiceService.php',
            'JMS\\Payment\\CoreBundle\\PluginController\\EntityPluginController' => 'getEntityPluginControllerService.php',
            ...
            'payment.form.choose_payment_method_transformer' => 'getPayment_Form_ChoosePaymentMethodTransformerService.php',
            'payment.form.choose_payment_method_type' => 'getPayment_Form_ChoosePaymentMethodTypeService.php',
            'payment.form.paypal_express_checkout_type' => 'getPayment_Form_PaypalExpressCheckoutTypeService.php',
            'payment.paypal.authentication_strategy.token' => 'getPayment_Paypal_AuthenticationStrategy_TokenService.php',
            'payment.paypal.client' => 'getPayment_Paypal_ClientService.php',
            'payment.plugin.paypal_express_checkout' => 'getPayment_Plugin_PaypalExpressCheckoutService.php',
        ...
        $this->aliases = array(
            'JMS\\Payment\\CoreBundle\\PluginController\\PluginController' => 'JMS\\Payment\\CoreBundle\\PluginController\\EntityPluginController',
            ...
            'payment.encryption.defuse_php_encryption' => 'JMS\\Payment\\CoreBundle\\Cryptography\\DefusePhpEncryptionService',
            'payment.paypal.authentication_strategy' => 'payment.paypal.authentication_strategy.token',
            'payment.plugin_controller' => 'JMS\\Payment\\CoreBundle\\PluginController\\EntityPluginController',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('b67lD-l4BD', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0tlOxDRHB1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k11bxsMbfg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v46T4MvUb+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wxs2vn-OcD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EntityBundle/Resources/views'), '!Entity');
        $instance->addPath(($this->targetDirs[3].'\\src\\YosrBundle/Resources/views'), 'Yosr');
        $instance->addPath(($this->targetDirs[3].'\\src\\YosrBundle/Resources/views'), '!Yosr');
        $instance->addPath(($this->targetDirs[3].'\\src\\MokhlesBundle/Resources/views'), 'Mokhles');
        $instance->addPath(($this->targetDirs[3].'\\src\\MokhlesBundle/Resources/views'), '!Mokhles');
        $instance->addPath(($this->targetDirs[3].'\\src\\ChaimaBundle/Resources/views'), 'Chaima');
        $instance->addPath(($this->targetDirs[3].'\\src\\ChaimaBundle/Resources/views'), '!Chaima');
        $instance->addPath(($this->targetDirs[3].'\\src\\WassimBundle/Resources/views'), 'Wassim');
        $instance->addPath(($this->targetDirs[3].'\\src\\WassimBundle/Resources/views'), '!Wassim');
        $instance->addPath(($this->targetDirs[3].'\\src\\SofieneBundle/Resources/views'), 'Sofiene');
        $instance->addPath(($this->targetDirs[3].'\\src\\SofieneBundle/Resources/views'), '!Sofiene');
        $instance->addPath(($this->targetDirs[3].'\\src\\SeifBundle/Resources/views'), 'Seif');
        $instance->addPath(($this->targetDirs[3].'\\src\\SeifBundle/Resources/views'), '!Seif');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'YosrBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\YosrBundle'),
                    'namespace' => 'YosrBundle',
                ),
                'MokhlesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MokhlesBundle'),
                    'namespace' => 'MokhlesBundle',
                ),
                'ChaimaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ChaimaBundle'),
                    'namespace' => 'ChaimaBundle',
                ),
                'WassimBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\WassimBundle'),
                    'namespace' => 'WassimBundle',
                ),
                'SofieneBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\SofieneBundle'),
                    'namespace' => 'SofieneBundle',
                ),
                'SeifBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\SeifBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'YosrBundle' => 'YosrBundle\\YosrBundle',
                'MokhlesBundle' => 'MokhlesBundle\\MokhlesBundle',
                'ChaimaBundle' => 'ChaimaBundle\\ChaimaBundle',
                'WassimBundle' => 'WassimBundle\\WassimBundle',
                'SofieneBundle' => 'SofieneBundle\\SofieneBundle',
                'SeifBundle' => 'SeifBundle\\SeifBundle',
            ...
            'payment.paypal.username' => 'your_api_username',
            'payment.paypal.password' => 'your_api_password',
            'payment.paypal.signature' => 'your_api_signature',
            ...
            'console.command.ids' => array(
                ...
                'console.command.jms_payment_corebundle_command_generatekeycommand' => 'JMS\\Payment\\CoreBundle\\Command\\GenerateKeyCommand',
